...
function oi_get_invitation_method_stats($method) {
	
}

function oi_get_invitation_count($status, $method='all', $start_date=0, $end_date=null) {
	if (null == $end_date) {
		$end_date = time();
	}
...
//			);
//			break;
			$clicked = oi_get_invitation_count('clicked', $method, $start_date, $end_date);
			$sent = oi_get_invitation_count('sent', $method, $start_date, $end_date);
			return $sent - $clicked;
